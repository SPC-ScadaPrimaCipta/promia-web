                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <li className="nav-item">
                                <ul>
                                    <li className="nav-item">
                                        <Link href="/risk-analysis/component" className="group">
                                            <div className="flex items-center">
                                                <IconMenuComponents className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Component</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/risk-analysis/risk-calculation" className="group">
                                            <div className="flex items-center">
                                                <IconMenuComponents className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Risk Calculation</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/risk-analysis/data-browser" className="group">
                                            <div className="flex items-center">
                                                <IconMenuComponents className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Data Browser</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/risk-analysis/risk-dashboard" className="group">
                                            <div className="flex items-center">
                                                <IconMenuComponents className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Risk Dashboard</span>
                                            </div>
                                        </Link>
                                    </li>
                                </ul>
