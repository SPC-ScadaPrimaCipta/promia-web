...
/**
 * GET /api/risk-analysis/report-2-1
 *
 * Query Parameters:
 ...
 *
 * Returns:
 * - data: All rows from dbo.RPT_2_1 for the given model and asset
 */
    ...
    try {
        ...
        const query = `
            SELECT
                ...
                EQUIPMENT,
                EQUIPMENT_PCT
            FROM dbo.RPT_2_1(@rbimId, @assetId)
            ORDER BY ASSET_NAME, RISK_ID
        `;
