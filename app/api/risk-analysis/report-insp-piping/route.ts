...
/**
 * GET /api/risk-analysis/report-insp-piping
 *
 * Query Parameters:
 ...
 *
 * Returns:
 * - data: All rows from dbo.RPT_INSP_PIPING for the given model and asset
 */
    ...
    try {
        ...
        const query = `
            SELECT
                ...
                REMARKS,
                COLOR
            FROM dbo.RPT_INSP_PIPING(@rbimId, @assetId)
        `;
        ...
        console.error('Error fetching report-insp-piping:', error);
        return NextResponse.json(
            {
                success: false,
