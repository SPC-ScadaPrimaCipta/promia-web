...
/**
 * GET /api/risk-analysis/report-10-2-pp
 *
 * Query Parameters:
 ...
 *
 * Returns:
 * - data: All rows from dbo.RPT_10_2_PP for the given model and asset
 */
    ...
    try {
        ...
        const query = `
            SELECT
                ...
                REMARKS,
                COLOR
            FROM dbo.RPT_10_2_PP(@rbimId, @assetId)
        `;
        ...
        console.error('Error fetching report 10-2-pp:', error);
        return NextResponse.json(
            {
                success: false,
