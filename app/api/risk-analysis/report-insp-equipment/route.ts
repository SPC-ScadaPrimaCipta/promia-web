...
/**
 * GET /api/risk-analysis/report-insp-equipment
 *
 * Query Parameters:
 ...
 *
 * Returns:
 * - data: All rows from dbo.RPT_INSP_EQUIPMENT for the given model and asset
 */
    ...
    try {
        ...
        const query = `
            SELECT
                ...
                REMARKS,
                COLOR
            FROM dbo.RPT_INSP_EQUIPMENT(@rbimId, @assetId)
        `;
        ...
        console.error('Error fetching report-insp-equipment:', error);
        return NextResponse.json(
            {
                success: false,
