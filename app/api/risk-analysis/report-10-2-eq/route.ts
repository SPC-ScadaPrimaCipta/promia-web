...
/**
 * GET /api/risk-analysis/report-10-2-eq
 *
 * Query Parameters:
 ...
 *
 * Returns:
 * - data: All rows from dbo.RPT_10_2_EQ for the given model and asset
 */
    ...
    try {
        ...
        const query = `
            SELECT
                ...
                COLOR,
                INSP_YEAR
            FROM dbo.RPT_10_2_EQ(@rbimId, @assetId)
        `;
        ...
        console.error('Error fetching report 10-2-eq:', error);
        return NextResponse.json(
            {
                success: false,
