...
/**
 * GET /api/risk-analysis/report-4-3-b
 *
 * Query Parameters:
 ...
 *
 * Returns:
 * - data: All rows from dbo.RPT_4_3_NEW for the given model and asset
 */
    ...
    try {
        ...
        const query = `
            SELECT
                ...
                REMARKS,
                COLOR
            FROM dbo.RPT_4_3_NEW(@rbimId, @assetId)
        `;
        ...
        console.error('Error fetching report 4-3-b:', error);
        return NextResponse.json(
            {
                success: false,
